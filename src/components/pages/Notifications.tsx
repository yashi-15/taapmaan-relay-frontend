  ...
  return (
    <div className="py-1 sm:py-3">
            <div className="flex gap-5">
                <button onClick={() => setTab("tasks") } className={`w-32 ${tab==="tasks"? 'border-b-3 border-secondary':'border-b-0'}`}>Tasks</button>
                <button onClick={() => setTab("notifications") } className={`w-32 ${tab==="notifications"? 'border-b-3 border-secondary':'border-b-0'}`}>Notifications</button>
            </div>
